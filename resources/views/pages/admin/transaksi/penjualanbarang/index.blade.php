    ...
    <div class="container-fluid mt--9">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h1>Data Transaksi Penjualan Barang</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            @endif
                            <div class="col">
                                <h3 class="mb-0">Daftar Penjualan Barang</h3>
                            </div>
                            <div class="col text-right">
                                <a href="{{ url('penjualanbarang/create') }}" class="btn btn-primary"><i class="fa fa-plus me-2"></i> Penjualan Barang</a>
                            </div>
                        </div>
                    </div>

                    <div class="card-body">
                        <form action="{{ url('penjualanbarang') }}" method="GET" class="form-inline">
                        ...
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->jumlahyangdibeli }}</td>
                                    <td>{{ \Carbon\Carbon::parse($item->tanggal_transaksi)->format('d F Y H:i:s') }}</td>
                                    <td>{{ $item->jenisbarang->nama_jenisbarang }}</td>
                                    <td class="text-center">
                                        <a class="btn btn-info btn-sm" href="{{ url('penjualanbarang/' . $item->id) }}"><i
                                                class="fa fa-eye"></i>
                                        </a>
                                        <a class="btn btn-success btn-sm" href="{{ url('penjualanbarang/' . $item->id . '/edit') }}">
...
@push('js')
    ...
    <script>
        ...
        $('.delete').click(function() {
            var penjualan = $(this).attr('data-id');
            Swal.fire({
                title: "Yakin?",
                ...
                if (result.isConfirmed) {
                    window.location = "delete_penjualanbarang/" + penjualan + "";
                    Swal.fire(
