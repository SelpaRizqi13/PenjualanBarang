            ...
            <div class="col-xl-12 mb-5 mb-xl-0">
                <div class="card shadow p-4">
                    <div class="card-header border-0">
                        <form method="POST" action="{{ url('penjualanbarang/' . $model->id) }}" id="barang-form">
                            @csrf
                            ...
                            <div class="form-row" id="barang-container">
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <select name="barang_id" class="barang_id form-control form-select-solid">
                                        <option value="{{ $model->barang_id }}" data-stok="{{ ($model->barang->stock + $model->jumlahyangdibeli) }}">{{ $model->barang->nama_barang }}</option>
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <input type="number" value="{{ $model->jumlahyangdibeli }}" class="form-control jumlahyangdibeli" name="jumlahyangdibeli" oninput="validateJumlah(this)">
                                </div>
                            </div>
...
@push('js')
    <script>
        ...
        function validateJumlah(input) {
            ...
            var selectedBarang = row.querySelector('.barang_id').selectedOptions[0]; 
            console.log('msa', selectedBarang)
